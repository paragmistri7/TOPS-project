    ...
    return (
        <>
            <MDBRow>
                ...
                <MDBCol md="2">
                    <input type="text" onChange={(event) => setFormData({ ...formData, [event.target.name]: event.target.value })} name="email" id="email" value={formData.email} />
                </MDBCol>
                <MDBCol md="2">
                    <input type="text" onChange={(event) => setFormData({ ...formData, [event.target.name]: event.target.value })} name="mobile" id="mobile" value={formData.mobile} />
                </MDBCol>
            </MDBRow>
        </>
    );
